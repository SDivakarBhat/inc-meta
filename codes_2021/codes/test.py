...
from models_test import Model, Word2Vec
...
def test(train_dataloader, test_dataloader, Model, log_dir, save_dir, f):
	...
	while(epoch < args.max_epoch):
		...
		f.write("\nTest Accuracy={}".format((sum(meter)/len(meter)),epoch))
...
if __name__=='__main__':
	...
	parse.add_argument('--max_epoch', type=int, default=10)
	parse.add_argument('--max_episode',type=int, default=10000)
	...
	test(train_dataloader, test_dataloader, model, log_dir, save_dir,f)
